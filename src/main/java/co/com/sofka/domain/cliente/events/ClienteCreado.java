...
public class ClienteCreado extends DomainEvent {
    ...
    private final Set<Contrato> contratos;
    private final Nombres nombres;
    private final Apellidos apellidos;
    private final Identificacion identificacion;

    public ClienteCreado(CuentaId accountId, Set<Contrato> contratos, Nombres nombres, Apellidos apellidos, Identificacion identificacion){
