...
public class Cliente extends AggregateEvent<ClienteId> {
    ...
    public Cliente(ClienteId id,CuentaId accountId,Set<Contrato> contratos, Nombres nombres, Apellidos apellidos, Identificacion identificacion){
        super(id);
        appendChange(new ClienteCreado(accountId, contratos , nombres, apellidos, identificacion)).apply();
    }
    ...
    protected Optional<Contrato> getContratoPorId(ContratoId id){
