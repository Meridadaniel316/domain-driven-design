...
import co.com.sofka.domain.cliente.Contrato;
...
public class CrearCliente implements Command {
    ...
    private final Set<Contrato> contrato;
    private final Nombres nombres;
    private final Apellidos apellidos;
    private final Identificacion identificacion;

    public CrearCliente(ClienteId id, CuentaId accountId, Set<Contrato> contrato, Nombres nombres, Apellidos apellidos, Identificacion identificacion){
        this.id = id;
    ...
    public Set<Contrato> getContrato() { return contrato; }
