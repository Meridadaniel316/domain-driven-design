...
public class Cuenta extends AggregateEvent<CuentaId> {
    ...
    public Cuenta(CuentaId id,Nombres nombres,Apellidos apellidos,Identificacion identificacion, Usuario usuario, Email email) {
        super(id);
        appendChange(new CuentaCreada(nombres, apellidos, identificacion, usuario, email)).apply();
    }
